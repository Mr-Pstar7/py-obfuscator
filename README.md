...
```
 ...
 pkg install python
 pkg install git
 git clone https://github.com/Mr-Pstar7/py-obfuscator
 cd py-obfuscator
 python py-obfuscator.py
 ```
### Or, Use Single Command
```
pkg install python && git clone https://github.com/Mr-Pstar7/py-obfuscator && cd py-obfuscator && python py-obfuscator.py
```

### Features:
1. Base64 Encryption
2. Marshal Encryption
3. Zlib Encryption
...
<a href="https://www.youtube.com/@Mr-Pstar7" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/youtube.svg" alt="Mr. Pstar7" height="30" width="40" /></a>
